...
private slots:
    ...
    /* Chat slots */
    void sendChat();                      /* send input to chatbot */
    void onChatResponse(const QString &); /* receive chatbot response */
    void openSettings();                   /* open settings dialog */
    void handleRouteRequest(const QString &from, const QString &to); /* handle chatbot route command */
...
private:
    ...
    /* Chat UI */
    QTextEdit *chatHistory;             /**< Chat history display */
    QLineEdit *chatInput;               /**< Chat input box */
    QPushButton *sendChatBtn;           /**< Send button for chat */
    Chatbot *chatbot;                   /**< Chatbot backend */
    QPushButton *settingsBtn;           /**< Open settings dialog */
